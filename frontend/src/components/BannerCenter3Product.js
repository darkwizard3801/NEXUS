  ...
  useEffect(() => {
    const fetchBanners = async () => {
      try {
        ...
        const center1Banners = data.banners.filter(banner => banner.status === 'approved' && banner.position === 'center-3');
...
export default BannerCenter3Product;
